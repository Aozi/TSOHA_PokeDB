...
class Pokemon {
    ...
    public function getPokemon($q_id) {
        $sql = "SELECT poke_id,poke_name,height,weight,hp,attack,defense,sp_atk,sp_def,speed FROM Pokemon WHERE poke_id == ?";
        ...
        $Pokemon = new Pokemon(
                $poke_data->poke_id, $poke_data->poke_name, $poke_data->height, $poke_data->weight, $poke_data->hp, $poke_data->attack, $poke_data->defense, $poke_data->sp_atk, $poke_data->sp_def, $poke_data->speed, $poke_data->ev_yield, $type_data->type1, $type_data->type2, $move_data
        );
        return $Pokemon;
    }
